...
public class Food extends Sprite {  
    ...
    public Food(String path, int x, int y, int height, int width) {
    ...
    public void move() {
        if (moving) {
            ...
            Rectangle limits = gameContainer.getBoundaries();

            if (y + height >= limits.height) {
                y = limits.height - height;
                velocityY = 0;
                moving = false;  
            }
